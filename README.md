...
- [Live Demo Link](https://amen-musingarimi.github.io/my-portfolio/)
...
To run tests, run the following command: npx hint . and npx stylelint "\*_/_.{css,scss}"
...
Feel free to check the [issues page](https://github.com/Amen-Musingarimi/Microverse-Portfolio-Project/issues).
...
I would like to thank my coding partners, Salma and Juliet.
